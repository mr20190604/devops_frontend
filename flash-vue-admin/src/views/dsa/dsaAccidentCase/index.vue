    ...
    <div class="table-list">
      <div class="btnLists">
        <el-button type="primary" class="set-common-btn blue-button" @click.native="add"
                   v-permission="['/accident/case/add']">{{ $t('button.add') }}
        </el-button>
        <el-button size="mini" class="set-common-btn blank-blue-button" @click.native="removeBatch1"
                   v-permission="['/accident/case/delete']">批量删除
        </el-button>
      </div>
      ...
      >
        ...
        <el-table-column label="事故时间" show-overflow-tooltip sortable prop="datetime">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="mini" icon="el-icon-edit" @click.native="editItem(scope.row)"
                       v-permission="['/accident/case/update']">{{ $t('button.edit') }}
            </el-button>
            <el-button type="text" size="mini" icon="el-icon-delete" @click.native="removeItem(scope.row)"
                       v-permission="['/accident/case/delete']">{{ $t('button.delete') }}
            </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <div class="block">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" class="align-right has-Label-Width">
          ...
          <el-form-item id="myself" class="dialog-button-list">
            ...
            <el-button @click.native="formVisible=false" class="set-common-btn blank-blue-button">{{ $t('button.cancel')
              }}
            </el-button>
          </el-form-item>
