...
<div class="table-list">
      <div class="btnLists">
          <el-button type="primary" class="set-common-btn blue-button" @click.native="add" v-permission="['/law/statute/add']">{{ $t("button.add") }}</el-button >
          <el-button size="mini" class="set-common-btn blank-blue-button" @click.native="removeBatch" v-permission="['/law/statute/delete']">批量删除</el-button>
      </div>
