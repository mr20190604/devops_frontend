<template>
  <div class="app-container">
        ...
        <el-row class="hasmarginBottom">
          <el-col :span="6">
            <el-form-item label="预案名称：">
              <el-input v-model="listQuery.planName" placeholder="请输预案名称" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="来源单位：">
              <el-input v-model="listQuery.planUnit" placeholder="请输来源单位" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
    ...
    <div class="table-list">
      <div class="btnLists">
        <el-button v-permission="['/emergency/plan/add']" type="primary" class="set-common-btn blue-button" @click.native="add">{{ $t("button.add") }}</el-button>
        ...
        <el-button v-permission="['/emergency/plan/delete']" size="mini" class="set-common-btn blank-blue-button" @click.native="removeBatch">批量删除</el-button>
      </div>
      <el-table
        ref="planTable"
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="228px">
          <template slot-scope="scope">
            <el-button v-permission="['/emergency/plan/update']" type="text" size="mini" icon="el-icon-edit" @click.native="editItem(scope.row)">{{ $t('button.edit') }}</el-button>
            <el-button v-permission="['/emergency/plan/delete']" type="text" size="mini" icon="el-icon-delete" @click.native="removeItem(scope.row)">{{ $t('button.delete') }}</el-button>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="预案名称：">
              <el-input v-model="form.planName" minlength="1" placeholder="请输入预案名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="预案类型：">
          ...
          <el-col :span="12">
            <el-form-item label="来源单位：">
              <el-input v-model="form.planUnit" minlength="1" placeholder="请输入来源单位" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="预案版本：">
              <el-input v-model="form.planVersion" minlength="1" placeholder="请输入预案版本" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="编制时间：">
              <el-date-picker
                v-model="form.editorDate"
                class="date_picker"
          ...
          <el-col :span="12">
            <el-form-item label="登记人：">
              <el-input v-model="form.register" minlength="1" placeholder="请输入登记人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
