  ...
  <div class="app-container">
    ...
    <div>
      ...
      <!--<div class="align-center">
        <el-button type="primary" @click="closeFatherDialog" class="set-common-btn blue-button">{{ $t('button.submit')
          }}
        </el-button>
            ...
            <el-scrollbar class="material-scrollbar">
              ...
              >
                ...
                <el-col :span="3" style="text-align: center">
                  <i v-if="index==form.details.length-1" class="el-icon-circle-plus-outline operate-icon"
                     @click.prevent="addDetail"/>
                  <i v-if="form.details.length>1" class="el-icon-remove-outline operate-icon" style="margin-left: 10px"
