<template>
  <div class="app-container">
    ...
    <div class="table-list">
      <div class="btnLists">
        <el-button type="primary" class="set-common-btn blue-button" @click.native="add"
                   v-permission="['/enterpriseBaseinfo/add']">{{ $t('button.add') }}
        </el-button>
        <el-button size="mini" class="set-common-btn blank-blue-button" @click.native="removeBatch"
                   v-permission="['/enterpriseBaseinfo/delete']">批量删除
        </el-button>
      </div>
      ...
      >
        ...
        <el-table-column label="企业名称" show-overflow-tooltip width="250px">
        ...
        <el-table-column label="安全负责人" show-overflow-tooltip width="140">
          <template slot-scope="scope">
            {{ scope.row.envSafeLeader }}
          </template>
        </el-table-column>

        <el-table-column label="联系方式" show-overflow-tooltip width="140">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center" width="170">
          <template slot-scope="scope">
            <el-button type="text" size="mini" icon="el-icon-edit" @click.native="editItem(scope.row)"
                       v-permission="['/enterpriseBaseinfo/update']">{{ $t('button.edit') }}
            </el-button>
            <el-button type="text" size="mini" icon="el-icon-delete" @click.native="removeItem(scope.row)"
                       v-permission="['/enterpriseBaseinfo/delete']">{{ $t('button.delete') }}
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog class="el-dialog-style common-dialog-style"
      ...
      <template>
        <el-tabs v-model="activeName" type="card" :before-leave="handleClick">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="从业人数：">
                      <el-input v-model="form.employmentNo" minlength=1
                  ...
                  <el-col :span="12">
                    <el-form-item label="企业电话：">
                      <el-input v-model="form.enterpriseOtel" minlength=1
                                oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                  ...
                  <el-col :span="12">
                    <el-form-item label="企业应急电话：">
                      <el-input v-model="form.enterpriseEmergencyTel" minlength=1
                                oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
          ...
          <el-tab-pane label="产品信息" name="second" id="second" style="height: 452px">
            <productInfo :enterpriseId="enterpriseId" @closeDialog="closeDialog"></productInfo>
          </el-tab-pane>
          <el-tab-pane label="风险单元" name="third" style="height: 452px">
    ...
    <el-dialog class="el-dialog-style common-dialog-style height750"
      ...
      <template v-if="enterpriseVisible">
        <el-tabs v-model="activeName" type="card" :before-leave="handleClick">
          ...
          <el-tab-pane label="产品信息" name="second" style="height: 404px">
            <productInfo1 :enterpriseId="enterpriseId" @closeDialog="closeDialog"></productInfo1>
          </el-tab-pane>
          <el-tab-pane label="风险单元" name="third" style="height: 404px">
