<template>
    <div class="app-container">
          ...
          <br>
            ...
            <el-row>
                <el-col :span="24">
                  ...
                  <el-button type="primary" size="mini"  icon="el-icon-view" @click="viewMaterial" >查看企业信息</el-button>
        ...
        <el-table ref="enterpriseTable" :data="list" v-loading="listLoading" element-loading-text="Loading" border
                  :row-key="row=>row.id"
