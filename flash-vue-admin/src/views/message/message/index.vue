        ...
        <el-row>
          <el-col :span="6">
            <el-form-item label="模板编号：">
              <el-input v-model="listQuery.tplCode" size="mini" placeholder="请输入模板编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="10">
            ...
            <el-button v-permission="['/message/clear']" type="danger" class="set-common-btn blue-button" @click.native="clear">{{ $t('button.clear') }}</el-button>
          </el-col>
        </el-row>
