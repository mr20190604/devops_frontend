  ...
  <div class="app-container">
    ...
    <div class="table-list">
      <div class="btnLists">
        ...
        <el-button type="primary" size="mini" class="set-common-btn blank-blue-button" @click.native="examine"
                   v-permission="['/threshold/manager/update']">批量审核
        </el-button>
      ...
      <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border
        ...
        <el-table-column label="审核日期" show-overflow-tooltip sortable prop="date">
          <template slot-scope="scope">
            {{scope.row.auditTime}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="mini" icon="el-icon-edit" @click.native="editItem(scope.row)"
                       v-permission="['/threshold/manager/update']">{{ $t('button.edit') }}
            </el-button>
            <el-button type="text" size="mini" icon="el-icon-delete" @click.native="removeItem(scope.row)"
                       v-permission="['/threshold/manager/delete']">{{ $t('button.delete') }}
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <div class="block">
        <el-form ref="thresholdForm" :model="thresholdForm" label-width="80px" class="align-right has-Label-Width"
                 :rules="examineRules" style="padding:20px 8px">
          <el-row>
            <el-col>
          ...
          <el-form-item id="myself" class="dialog-button-list">
            <el-button type="primary" @click="saveThreshold" class="set-common-btn blue-button">{{ $t('button.submit')
              }}
            </el-button>
            <el-button @click.native="thresholdVisible = false" class="set-common-btn blank-blue-button">{{
              $t('button.cancel') }}
            </el-button>
          </el-form-item>
        </el-form>
