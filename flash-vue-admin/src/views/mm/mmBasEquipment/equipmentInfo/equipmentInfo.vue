<template>
  <div>
    <el-form ref="form" :model="baseInfo"  label-width="120px" class="align-right has-Label-Width">
      <el-row>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="设备类型：">
            <dict-select v-model="baseInfo.equipmentType" :disabled="disableFlag" minlength=1 dict-name="设备类型"></dict-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="父设备ID">
            <el-input v-model="baseInfo.parentId" :disabled="disableFlag" minlength=1  oninput="value=value.replace(/[^0-9]/g,'')" ></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="供电方式">
            ...
            <dict-select dict-name="供电方式" :disabled="disableFlag" :value="baseInfo.powerModel" v-model="baseInfo.powerModel"></dict-select>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="供电电压">
            <el-input v-model="baseInfo.supply_voltage" :disabled="disableFlag" minlength=1  oninput="value=value.replace(/[^0-9]/g,'')" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="传输方式">
            <!--<el-input v-model="baseInfo.transmissionType" :disabled="disableFlag" minlength=1   ></el-input>-->
            <dict-select dict-name="传输方式" :disabled="disableFlag" :value="baseInfo.transmissionType" v-model="baseInfo.transmissionType"></dict-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="传输频率">
            <el-input v-model="baseInfo.transmissionFrequency" :disabled="disableFlag" minlength=1  oninput="value=value.replace(/[^0-9]/g,'')" ></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="子系统划分">
            <el-select v-model="sysValue" multiple  :disabled="disableFlag"  placeholder="请选择">
              <el-option
