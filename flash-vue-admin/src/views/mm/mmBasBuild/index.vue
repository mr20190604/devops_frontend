  ...
  <div class="app-container two-line-form-container">
    ...
    <div class="table-list outer-table-list">
      ...
      >
        ...
        <el-table-column label="建筑用途" show-overflow-tooltip>
          <template slot-scope="scope">
            {{ scope.row.dictBuildName }}
          </template>
        </el-table-column>
      ...
      <div class="block">
        <el-form ref="form" :model="form" :rules="rules" label-width="120px" class="align-right has-Label-Width" size="mini">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="建筑用途：" prop="dictBuildId">
                <dict-select v-model="form.dictBuildId" dict-name="建筑用途" placeholder="请选择建筑用途" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="经纬度：" prop="lngAndLat">
                <el-input v-model="form.lngAndLat" placeholder="请输入经纬度" />
                <i class="el-icon-location-information" style="cursor: pointer;color: #1a90ff;" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
