<template>
  <div>
    <div style="display: inline-block">
      ...
      <el-button type="primary" size="mini" icon="el-icon-search" @click.native="search">查询</el-button>
    ...
    <el-card >
      <v-chart ref="thirdChart" style="width: 100%;" :options="lineData"/>
    </el-card>
  </div>
</template>
